...
- **İstemci uygulaması (isteğe bağlı)** - Başarı oranını artırmak için macOS, Linux ve Windows desteği
...
3. macOS için [GitHub Releases](https://github.com/dessant/buster-client/releases) sayfasından `.dmg` indir ve kur
